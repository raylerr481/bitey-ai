...
class Bitey_API
{
    ...
    {
        register_rest_route('bitey/v1', '/chat', array('methods'=>'POST','permission_callback'=>'__return_true','callback'=>array($this,'rest_chat')));
    }
    ...
    {
        error_log('[Bitey] '.$code.' '.wp_json_encode($extra));wp_send_json_error(array_merge(array('code'=>$code,'reply'=>$reply),$extra),$status);
    }
