...
<div class="bitey-header"><div class="bitey-brand"><span class="bitey-avatar">🤖</span><div><strong>Bitey AI</strong><small>Asistente inteligente</small></div></div><div class="bitey-header-actions"><span id="bitey-memory" class="bitey-memory" title="Memoria de esta conversación" aria-label="Memoria de esta conversación">•</span><button id="bitey-close" type="button" aria-label="Cerrar">×</button></div></div>
