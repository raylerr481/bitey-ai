...
<div id="bitey-container" class="bitey" aria-label="Bitey AI">
  ...
  <div id="bitey-window" class="bitey-window" hidden role="dialog" aria-label="Bitey AI">
    <header class="bitey-header"><div class="bitey-brand"><span class="bitey-avatar" aria-hidden="true">🤖</span><div><strong>Bitey AI</strong><small>Inteligencia empresarial en aprendizaje</small></div></div><button id="bitey-close" type="button" aria-label="Cerrar">×</button></header>
    <div class="bitey-context-note">Contexto empresarial activo • IAs externas rectoras • Bitey aprende y es evaluado</div>
    ...
    <div id="bitey-work" class="bitey-work" hidden role="status" aria-live="polite"><span>🧠</span><span id="bitey-work-label">Preparando contexto empresarial…</span></div>
    <div id="bitey-messages" class="bitey-messages" aria-live="polite"><div class="bitey-message bitey-ai">Hola 👋 soy Bitey. Estoy aquí para ayudarte dentro del contexto de esta empresa.</div></div>
